...
local vu616 = loadstring(game:HttpGet("https://raw.githubusercontent.com/Dev-AnhTuansitink/Ui_vip_pro/refs/heads/main/ui.redz.txt"))():MakeWindow({
    ["Title"] = "TuanxAov Hub",
    ["SubTitle"] = "by real_AnhTuanAov",
...
vu618.Image = "rbxassetid://128528465536598"
vu618.BackgroundTransparency = 1 -- Nền trong suốt
vu618.Parent = v617
...
-- [[ PHẦN THÊM VÀO: VIỀN CẦU VỒNG ]] --
local vUIStroke = Instance.new("UIStroke")
vUIStroke.Thickness = 3 -- Độ dày của viền (chỉnh số này nếu muốn dày/mỏng hơn)
vUIStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
vUIStroke.Parent = vu618
...
task.spawn(function()
    ...
    while true do
        if vUIStroke then
            vUIStroke.Color = rainbowColors[i]
        end
        i = i % #rainbowColors + 1
        task.wait(0.15) -- Tốc độ đổi màu (càng nhỏ càng nhanh)
    end
end)
